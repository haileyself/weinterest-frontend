                ...
                <div className="content_list">
                  <div className="ct_choice_li">
                    <div className="choice_list ">
                      <button className="choice_item choice_item_board">
                        보드
                      </button>
                    </div>
                    <div className="choice_list">
                  ...
                  <div className="picture_frame">
                    <div className="picture_outerframe">
                      <div className="picture_innerframe">
                        <div className="pic_item pic_first"></div>
                        <div className="pic_item pic_second"></div>
                        <div className="pic_item pic_third"></div>
                        <div className="pic_item pic_forth"></div>
                        <div className="pic_item pic_fifth"></div>
                        <div className="pic_item pic_sixth"></div>
                      </div>
