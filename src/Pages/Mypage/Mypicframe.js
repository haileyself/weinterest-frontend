            ...
            <div className="picture_frame">
                <div className="picture_outerframe">
                    ...
                    <div> */}
                        ...
                        <div className="pic_item pic_first" style={{ backgroundImage: `url(${this.props.imageList[0]})`}}>
                        </div>
                        <div className="pic_item pic_second" style={{ backgroundImage: `url(${this.props.imageList[1]})`}}>
                        </div>
