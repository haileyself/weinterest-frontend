...
const dataA = [
  ...
  "https://i.pinimg.com/170x/57/6a/b8/576ab8609de8543c31a3a0bde8ac3d32.jpg",
  "https://i.pinimg.com/236x/ce/0e/40/ce0e400cb1b0b723e52304cde3ab4d4a.jpg",
  "https://i.pinimg.com/170x/ff/02/27/ff02271dece2d38f23b52e2470e82ecd.jpg",
  "https://i.pinimg.com/170x/e6/cc/b3/e6ccb3a4f1eb09461d19208d5535751e.jpg",
  "https://i.pinimg.com/564x/8a/91/84/8a918435ad0fb34986faa032c35000a2.jpg",
  ...
  render() {
    return (
      <div className="pinlist_wrapper">
        ...
        <>
          {this.props.boardList.map(el => {
            let pinList = el.pins.map((pin, index) => {
              // debugger;
              return <PhotoBox info={pin} key={this.key + index} />;
            });

            this.key += el.pins.length;

            return pinList;
          })}
          {/* {dataA.map((el, i) => {
            return <PhotoBox img={el} key={i} />;
          })} */}
        </>
      </div>
    );
